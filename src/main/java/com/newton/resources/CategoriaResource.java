...
import com.newton.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objDto) {
		Categoria obj = service.fromDTO(objDto); //Realiza validação
	...
	public ResponseEntity<Void> update(@PathVariable Integer id, @Valid @RequestBody CategoriaDTO objDto) {
		Categoria obj = service.fromDTO(objDto); //Realiza validação
		obj.setId(id); //Garantir que o objeto atualizado é o de id informado
